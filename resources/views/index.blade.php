...
<body>
    ...
    <section id="about" class="py-8">
        <div class="container mx-auto px-4">
            ...
            <p>Halo, saya Raya Abna A, seorang pelajar SMK di bidang Rekayasa Perangkat Lunak (PPLG). Saya sangat tertarik dengan pemrograman dan pengembangan web.</p>
        </div>
    </section>
    ...
    <footer class="bg-[#0a2c54] text-white py-4 text-center">
        <p>&copy; 2024 Raya. Semua hak dilindungi.</p>
    </footer>
</body>
</html>